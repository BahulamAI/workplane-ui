import type { CommandGateway, CommitResult, WorkplaneDocument } from "@bahulam/workplane-core";
import { workplaneError } from "@bahulam/workplane-protocol";
import type { Actor, CommittedEvent, Transaction } from "@bahulam/workplane-protocol";
 ...
 * same conformance suite in `@bahulam/workplane-testkit`, which is the whole
